...
export default function CandidateProfilePage() {
  ...
  function loadFromProfile(p) {
    ...
    setGraduationPercentage(p?.graduationPercentage != null ? String(p.graduationPercentage) : "");
          ...
          <form className="flex flex-col gap-6" onSubmit={handleSave}>
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            ...
                            setResumeUrl(`http://localhost:8080/api${res.url}`);
                            setMessage("Resume uploaded. Click Save Profile to apply.");
                          } catch (err) {
            ...
            <section className="bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                  ...
                  <div key={idx} className="bg-slate-800/50 rounded-xl p-4 border border-white/5 relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mr-6">
                      ...
                      <div className="space-y-1 md:col-span-2">
                        ...
                        {editing ? <textarea className="hc-input text-sm min-h-[80px]" placeholder="Briefly describe what you built and your role..." value={item.summary ?? ""} onChange={e => { const next = [...projects]; next[idx].summary = e.target.value; setProjects(next); }} />
                                 : <p className="text-sm text-slate-300 whitespace-pre-line">{item.summary || "No summary provided."}</p>}
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {editing && (
                  <button type="button" className="hc-btn-ghost text-sm w-full border border-dashed border-slate-600 hover:border-slate-400" onClick={() => setProjects([...projects, { name: "", duration: "", summary: "" }])}>
                    + Add Project
                  </button>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    {editing ? <input className="hc-input text-sm" placeholder="e.g. 80%" value={graduationPercentage} onChange={e => setGraduationPercentage(e.target.value)} />
                             : <p className="text-sm text-white">{graduationPercentage ? `${graduationPercentage}%` : "Not provided"}</p>}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    {editing ? <input className="hc-input text-sm" placeholder="e.g. 85%" value={class12} onChange={e => setClass12(e.target.value)} />
                             : <p className="text-sm text-white">{class12 ? `${class12}%` : "Not provided"}</p>}
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    {editing ? <input className="hc-input text-sm" placeholder="e.g. 90%" value={class10} onChange={e => setClass10(e.target.value)} />
                             : <p className="text-sm text-white">{class10 ? `${class10}%` : "Not provided"}</p>}
                  </div>
                </div>
              </div>
            </section>
